...
Tags: filter, hide, admin, management
...
WP Plugin Filter allows you to hide specific plugins from the plugin list in the WordPress admin dashboard.
...
3. Once you are logged in, go to Settings > WP Plugin Filter. From there, you can select individual plugins to hide or use the "Toggle All" option to select all plugins and then save the changes.
...
1. Navigation
2. WordPress Plugin Filter Settings
